...
const Galeri = () => {
  const { images, loading, hasMore, loadMore, resetAndReload } = useGaleri();
  ...
  if (loading && images.length === 0) {
    return <LoadingSpinner text="Memuat galeri..." />;
  }

  if (!loading && images.length === 0) {
    return <p className="galeri-status-text text-center my-5">Belum ada gambar di galeri.</p>;
  }
              ...
              <div key={gambar.id} className="col-lg-4 col-md-6 mb-4">
                ...
                >
                  <img 
                    ...
                    className="galeri-image img-shimmer" 
                    loading="lazy"
                  />
                  <div className="galeri-card-hover-overlay">
                    <div className="galeri-card-hover-info">
                      <span className="galeri-card-hover-tag">HMRPL Gallery</span>
                      <h4 className="galeri-card-hover-caption">
                        {gambar.caption ? (gambar.caption.length > 50 ? `${gambar.caption.substring(0, 50)}...` : gambar.caption) : "Dokumentasi Kegiatan"}
                      </h4>
                      <span className="galeri-card-hover-action">Lihat Detail ➔</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="galeri-modal-info-panel">
                  ...
                  <div className="galeri-modal-footer">
                    <div className="galeri-modal-tagline">
                      ...
                      <small className="text-muted">#HMRPLJaya #WebDeveloper</small>
                    </div>
